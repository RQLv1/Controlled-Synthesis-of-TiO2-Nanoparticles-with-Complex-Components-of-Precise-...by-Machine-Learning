...
def single_line_change(water_precursor_molratio, pH, temperature, reaction_duration, 
    ...
    #De
    X_select_De = encoder(X, y_De, 'Precursor_species', 'LeaveOneOutEncoder')
    X_select_De = encoder(X_select_De, y_De, 'Additive_species', 'LeaveOneOutEncoder')
    X_select_De = encoder(X_select_De, y_De, 'Dopant_species', 'LeaveOneOutEncoder')
    X_select_De = encoder(X_select_De, y_De, 'Solution_species', 'LeaveOneOutEncoder')
    ...
    #n
    X_select_n = encoder(X, y_n, 'Precursor_species', 'LeaveOneOutEncoder')
    X_select_n = encoder(X_select_n, y_n, 'Additive_species', 'LeaveOneOutEncoder')
    X_select_n = encoder(X_select_n, y_n, 'Dopant_species', 'LeaveOneOutEncoder')
    X_select_n = encoder(X_select_n, y_n, 'Solution_species', 'LeaveOneOutEncoder')
